          ...
          return (
            <div key={`mob-${course._id}`} className="flex items-center gap-3 p-3 border border-border rounded-card hover:border-primary transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-text-primary text-sm truncate">{course.title}</p>
      ...
      <table className="w-full text-sm hidden sm:table">
        <thead>
          <tr className="border-b border-border text-left">
            ...
            {/* Coluna "Professor" — ocultar em telas abaixo de lg */}
            <th className="pb-3 pr-4 text-xs font-bold text-text-muted uppercase tracking-wider whitespace-nowrap hidden lg:table-cell">Professor</th>
